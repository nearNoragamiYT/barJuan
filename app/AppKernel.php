...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = [
            ...
            new Nosotros\NosotrosBundle\NosotrosNosotrosBundle(),
            new NosotrosII\nosotrosBundle\NosotrosIInosotrosBundle(),
            new Contactar\ContactarBundle\ContactarContactarBundle(),
            new Tapas\TapasBundle\TapasTapasBundle(),
            new Inicio\inicioBundle\InicioinicioBundle(),
        ];
